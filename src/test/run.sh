...
java  -cp target/test-classes/:target/classes/  -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=6798 -javaagent:/Users/joeylee/workspace/HotswapAgent/hotswap-agent/target/hotswap-agent.jar  HotSwapTest
